...
<body>
    <div class="container">
        ...
        <div class="card">
            <div class="card-title">Transfert d'argent</div>
            <div class="card-subtitle">Envoyer de l'argent à un autre numéro</div>

            <div class="info-box">
                <strong>Info :</strong> Des frais seront appliqués selon le barème en vigueur. Le destinataire recevra uniquement le montant transféré.
            </div>

            <form action="/client/transfert" method="post">
                <div class="form-group">
                    <label for="numero_destinataire">Numéro du destinataire</label>
                    <input type="text" id="numero_destinataire" name="numero_destinataire" placeholder="Ex: 0341234567" required>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="submit-btn">Confirmer le transfert</button>
            </form>
        </div>
    </div>
</body>
